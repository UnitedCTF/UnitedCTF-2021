...
<?php
	...
	if (isset($_POST['u']) && !empty($_POST['u'])) {
		if (isset($_POST['p']) && !empty($_POST['p'])) {
			...
			if (stripos($reqstr, 'flag') === false) {
				...
				// vulnérable à:  " union select 1,2,cast(x'666c6167' as text) from cast(x'666c6167' as text)--
	...
	if (!file_exists($filename)) {
		...
		$db->query('INSERT INTO "flag" ("flag") VALUES ("FLAG-a7541918ece21a8dc17a3dc9bae1f23bYoureTheBoss")');
